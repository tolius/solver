...
extern int      dict_data_zip(
   ...
   const char *preFilter, const char *postFilter, const char *origFilename, int chunkLength, unsigned short formatVersion);
extern int      dict_databuf_zip(const char *data, unsigned long len_data, const char *outFilename,
	const char *preFilter, const char *postFilter, const char *origFilename, int chunkLength, unsigned short formatVersion);
